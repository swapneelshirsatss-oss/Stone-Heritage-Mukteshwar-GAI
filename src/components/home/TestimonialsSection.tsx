      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-primary/70 max-w-2xl mx-auto leading-relaxed">
            Discover why guests rate their stay at Stone Heritage Mukteshwar 4.9/5 stars across 250+ Google reviews. Read stories of peaceful getaways, warm hospitality, and unforgettable Himalayan views.
          </p>
        </div>
